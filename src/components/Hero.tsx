...
export default function Hero({ name, title }: HeroProps) {
  ...
  return (
    <section id="home" className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-cyber-grid py-20 px-4 transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 space-y-8">
        ...
        <div className="space-y-4">
          ...
          >
            {t('hero_greeting')} <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-teal-300 to-blue-500 neon-text-cyan">{name}</span>.
          </motion.h1>
        ...
        >
          <div className="grid grid-cols-3 gap-4 border border-slate-900 bg-slate-950/70 backdrop-blur px-6 py-4 rounded-xl text-center">
            <div>
              ...
              <div className="font-sans text-[10px] text-slate-500 uppercase tracking-widest mt-1">
